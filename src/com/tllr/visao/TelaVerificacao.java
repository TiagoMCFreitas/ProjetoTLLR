...
public class TelaVerificacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelTitulo2.setText("Insira o código fornecido pelo RH");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            CODIGO objetoCodigo = new CODIGO(codigo);
            objetoCodigo.listagem();
            if(objetoCodigo.getCodigo().equals(codigo)){
                this.dispose();
                ...
                JOptionPane.showMessageDialog(this, "Codigo informado errado, verifique novamente");
            }
            jTextField1.setText("");
        } catch (Exception ex) {
            Logger.getLogger(TelaVerificacao.class.getName()).log(Level.SEVERE, null, ex);
        }
