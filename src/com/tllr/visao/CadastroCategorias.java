...
public class CadastroCategorias extends javax.swing.JFrame {
    ...
    public void imprimirDadosNaGrid(ArrayList<Categoria> listaDeCategorias)throws Exception{
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Cadastro de Categorias");
    ...
    private void jLabelBotaoAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBotaoAlterarMouseClicked
        ...
        if(jTableCategorias.getSelectedRow() != -1){
            try {
                ...
                Categoria objetoAlterar = new Categoria(Integer.parseInt(jTextFieldIdentificador.getText()), jTextFieldDescricao.getText(), Float.parseFloat(jTextFieldValor.getText()));

                categoriaControle.alterar(objetoAlterar);
                imprimirDadosNaGrid(categoriaControle.listagem());
            } catch (Exception ex) {
