...
public class TelaDeCadastroModelo extends javax.swing.JInternalFrame {
 ...
 public void imprimirDadosNaGrid(ArrayList<Modelo>  listaDeModelos) {
            ...
            while (lista.hasNext()) {
                ...
                ImageIcon marcaLogo = new ImageIcon(aux.getMarca().getUrl());
                //Incluir nova linha na Tabela
                Object[] dados = {saida[0], saida[1], saida[2], iconlogo,marcaLogo};
                model.addRow(dados);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(0, 450, 930, 200);
    ...
    private void jLabelBotaoIncluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBotaoIncluirMouseClicked
        ...
        try {
            Modelo objeto = new Modelo(0, jTextFieldDescricao.getText(), jTextFieldUrl.getText(), pegarMarca.getMarca());
    ...
    private void jComboBoxMarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxMarcaActionPerformed
         try {
             ...
             pegarMarca.setMarca(lista.get(i));
             }
